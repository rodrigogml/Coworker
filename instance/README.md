...
As decisões e a documentação de desenvolvimento ficam na raiz do repositório.
O runtime não deve usar o `AGENTS.md` da raiz como instrução operacional.
...
A raiz do repositório contém os arquivos de desenvolvimento e os wrappers de
instalação. O runtime executável da instância é este diretório `instance/`.

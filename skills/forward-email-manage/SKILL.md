...
Use exclusivamente `python skills/forward-email-manage/scripts/forward_email.py` para
...
1. Usar `python skills/forward-email-manage/scripts/forward_email.py doctor` quando
...
python skills/forward-email-manage/scripts/forward_email.py domains show `
  --domain exemplo.com
python skills/forward-email-manage/scripts/forward_email.py domains verify `
  --domain exemplo.com
python skills/forward-email-manage/scripts/forward_email.py domains create `
  --domain exemplo.com
python skills/forward-email-manage/scripts/forward_email.py domains update `
  --domain exemplo.com --phishing-protection
python skills/forward-email-manage/scripts/forward_email.py domains delete `
  --domain exemplo.com

python skills/forward-email-manage/scripts/forward_email.py aliases list `
  --domain exemplo.com
python skills/forward-email-manage/scripts/forward_email.py aliases show `
...
python skills/forward-email-manage/scripts/forward_email.py aliases update `
  --domain exemplo.com --name contato `
  --recipient novo-destino@exemplo.net
python skills/forward-email-manage/scripts/forward_email.py aliases delete `
  --domain exemplo.com --name contato
```

...
def load_config(path: Path) -> ForwardEmailConfig:
    ...
    try:
        ...
        raise ForwardEmailToolError(
            ...
            f"'{EXAMPLE_CONFIG}' para '{DEFAULT_CONFIG}' e ajuste a referência."
        ) from exc
    ...
    if not api_base.startswith("https://"):
        raise ForwardEmailToolError("'api_base' deve usar HTTPS.")
    if not credential_ref:
        raise ForwardEmailToolError("'credential_ref' não pode ficar vazio.")

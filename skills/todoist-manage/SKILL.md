...
Usar exclusivamente `python skills/todoist-manage/scripts/todoist.py`. Obter o token
...
python skills/todoist-manage/scripts/todoist.py sections list --project-id ID
python skills/todoist-manage/scripts/todoist.py labels list
python skills/todoist-manage/scripts/todoist.py tasks list --project-id ID
python skills/todoist-manage/scripts/todoist.py tasks show --id ID
```
...
python skills/todoist-manage/scripts/todoist.py tasks update `
  --id ID --content "Enviar relatório revisado"

python skills/todoist-manage/scripts/todoist.py tasks move `
  --id ID --section-id SECAO

python skills/todoist-manage/scripts/todoist.py tasks close --id ID
python skills/todoist-manage/scripts/todoist.py tasks reopen --id ID
```
...
```powershell
python skills/todoist-manage/scripts/todoist.py projects create --name "Pessoal"
python skills/todoist-manage/scripts/todoist.py sections create `
  --project-id ID --name "Esta semana"
python skills/todoist-manage/scripts/todoist.py labels create --name "aguardando"
```

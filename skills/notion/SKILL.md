...
Usar exclusivamente `python skills/notion/scripts/notion.py`. Obter o token
...
python skills/notion/scripts/notion.py pages edit `
  --id ID --changes-file data/work/alteracoes.json

python skills/notion/scripts/notion.py pages replace `
  --id ID --markdown-file data/work/nota-revisada.md

python skills/notion/scripts/notion.py pages trash --id ID
python skills/notion/scripts/notion.py pages restore --id ID
```

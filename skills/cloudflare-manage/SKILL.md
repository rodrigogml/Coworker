...
Use exclusivamente `python skills/cloudflare-manage/scripts/cloudflare.py` para
...
1. Usar `python skills/cloudflare-manage/scripts/cloudflare.py doctor` quando for
...
python skills/cloudflare-manage/scripts/cloudflare.py zones list --name exemplo.com
python skills/cloudflare-manage/scripts/cloudflare.py zones create `
  --name exemplo.com --account-id <account_id>

python skills/cloudflare-manage/scripts/cloudflare.py dns list --zone exemplo.com
python skills/cloudflare-manage/scripts/cloudflare.py dns list `
  --zone exemplo.com --name www --type A
python skills/cloudflare-manage/scripts/cloudflare.py dns show `
  --zone exemplo.com --name www --type A

python skills/cloudflare-manage/scripts/cloudflare.py dns create `
  --zone exemplo.com --type A --name www --content 192.0.2.10 --proxied
python skills/cloudflare-manage/scripts/cloudflare.py dns update `
...
python skills/cloudflare-manage/scripts/cloudflare.py dns delete `
